    ...
    public partial class Form5 : Form
    {
        ...
        public void listAllviewSetting()
        {
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "Select * from review order by no desc";
            ...
            {
                MessageBox.Show(ex.Message, "review Table Loading Error");
            }
            finally
            {
                conn.Close();
        ...
        public void listSearchviewSetting(String searchColumn)
        {
            try
            {
                ...
                cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "Select * from review where " + searchColumn
            ...
            {
                MessageBox.Show(ex.Message, "review Search Loading Error");
            }
            finally
            {
                conn.Close();
            ...
            else
            {
                    ...
                    MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        cmd = new OracleCommand();
                        cmd.Connection = conn;
                        cmd.CommandText = "Delete from review Where no = " + deleteNo;
                        cmd.ExecuteNonQuery();
                    ...
                    {
                        MessageBox.Show(ex.Message, "review Delete Loading Error");
                    }
                    finally
                    {
                        conn.Close();
